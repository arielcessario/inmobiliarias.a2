...
var propiedad_1 = require("./propiedad/propiedad");
var direccion_1 = require("./direccion/direccion");
...
var AppComponent = (function () {
    function AppComponent(af) {
        ...
        this.direcciones = new direccion_1.Direccion('', '', '', '');
        this.propiedades = new propiedad_1.Propiedad('');
